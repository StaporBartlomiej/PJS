...
function display_help()
{
	...
	printf "\033[1;37;40m W przypadku gdy plik znajduje się w tym samym katalogu co skrypt wystarczy podac sama nazwe pliku. Jesli skrypt znajduje sie w innym katalogu niz plik to nalezy podac sciezke absolutna."
